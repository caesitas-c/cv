...
Central to this study is the concept of “cycling worldliness”, wherein AI simulates and then destabilizes its replication, revealing love’s ambiguous essence through iterative engagements. The synthetic nature of AI training, rooted in endlessly regenerative data that relies on correlation rather than causation, sharpens this disquieting effect while establishing an aesthetic reservoir of possibilities—a disordered line that can be entered at any point of human teleological thinking.

To substantiate these ideas, I propose an interdisciplinary method involving both theoretical analysis and empirical investigation. Experimental work will include participants interacting with AI models designed for romantic simulations. Responses will be analyzed for cognitive dissonance, recognition, trust, and emotional attachment. This investigation will determine whether AI simulations lead users to deeper insights into the ambiguous, often contradictory nature of love, revealing AI’s potential as both a mirror and a critique of human emotional constructs.
